...
public class CustomersDAO {
	...
	public void edit(Customers c) {
		...
		String sql = "UPDATE customers set company = ?, last_name = ?, first_name = ?, mobile_phone = ?, city = ?, state_province = ?, zip_postal_code = ?, country_region = ? WHERE id = ?";
